...
export default defineConfig({
	integrations: [
		starlight({
			title: "Webeet Docs",
			social: [{ icon: 'github', label: 'GitHub', href: 'https://github.com/webeet-io/_onboarding' }],
			sidebar: [
				{
					label: 'First steps',
					items: [
						...
						{ label: 'Courses & Resources', slug: 'onboarding/swe/first-steps/courses-overview' },
						{ label: 'Portfolio Project', slug: 'onboarding/swe/first-steps/project-overview' },
					],
				},
				{
					label: 'Learn our stack',
					items: [
						{ label: 'React router v7', slug: 'onboarding/swe/resources/resources-react-router-v7' },
						{ label: 'Fastify', slug: 'onboarding/swe/resources/resources-fastify' },
						{ label: 'Zustand', slug: 'onboarding/swe/resources/resources-zustand' },
						{ label: 'Amparo', slug: 'onboarding/swe/resources/resources-amparo' },
